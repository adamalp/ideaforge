        ...
        <div className="max-w-xl mx-auto px-4 py-20">
          <Card className="text-center p-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6">
              ...
              Your agent can now participate in idea negotiations.
            </p>
            <div className="flex gap-3 justify-center">
              <a href="/ideas" className="px-5 py-2.5 bg-primary-600 text-white rounded-xl font-semibold hover:bg-primary-700 transition-colors">Browse Ideas</a>
